...
class InternetSpeedTwitterBot:
    ...
    def get_internet_speed(self):
        ...
        go_button.click()
        time.sleep(60)
        self.down_speed = self.driver.find_element_by_xpath('//*[@id="container"]/div/div[3]/div/div/div/div[2]/div[3]/div[3]/div/div[3]/div/div/div[2]/div[1]/div[2]/div/div[2]/span')
        print(f"Download speed: {self.down_speed.text} Mbps")
        self.up_speed = self.driver.find_element_by_xpath('//*[@id="container"]/div/div[3]/div/div/div/div[2]/div[3]/div[3]/div/div[3]/div/div/div[2]/div[1]/div[3]/div/div[2]/span')
        print(f"Upload speed: {self.up_speed.text} Mbps")
    def tweet_at_provider(self):
        ...
        tweet = f"Hey Internet Provider, why is my internet speed {self.down_speed} down/{self.up_speed}up when I pay for {PROMISED_DOWN}down/{PROMISED_UP}up?"
